    ...
    >
      <StyledToolBar>
        ...
        >
          ...
          {isDropdownOpen && (
            <div className="dropdown-content">
              <h5 className="hh" onClick={()=>navigate("/recipe1")}>Quick Recipes</h5>
              <h5 className="hh" onClick={()=>navigate("/lunch")}>Dinner Recipes</h5>
        ...
        <div className="dropdown-button" style={{ display: 'flex', alignItems: 'center', fontWeight: 'bold' ,marginBottom:"8px"}}>
  <p style={{ margin: 0 }} onClick={() => navigate("/mongoPage")}>User Uploads</p>
  <BreakfastDiningIcon
    sx={{ fontSize: '30px', marginLeft: '8px', cursor: 'pointer' }}
    onClick={() => navigate("/mongoPage")}
  />
</div>
</div>
        ...
        <div className="dropdown-container" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        <div className="dropdown-button" style={{ display: 'flex', alignItems: 'center', fontWeight: 'bold' ,marginBottom:"8px"}}>
  <p style={{ margin: 0 }} onClick={() => navigate("/filter")}>Search</p>
  <SearchIcon
    sx={{ fontSize: '30px', marginLeft: '8px', cursor: 'pointer' }}
